...
<head>
    <meta charset="UTF-8">
    <title>Meeting Cancelled Notification</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="email-header">
            <div class="email-subject">Subject: Tutoring Session Cancelled</div>
        ...
        <div class="email-body">
            ...
            <div class="notification-bubble">
                <p><strong>A tutoring session has been cancelled.</strong></p>
