...
<head>
    <meta charset="UTF-8">
    <title>Request Approved Notification</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="email-header">
            <div class="email-subject">Subject: Tutoring Request Approved</div>
        ...
        <div class="email-body">
            ...
            <div class="notification-bubble">
                <p><strong>Your tutoring session request has been approved.</strong></p>
