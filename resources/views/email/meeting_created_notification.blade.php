...
<head>
    <meta charset="UTF-8">
    <title>Meeting Created Notification</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="email-header">
            <div class="email-subject">Subject: Tutoring Session Scheduled</div>
        ...
        <div class="email-body">
            ...
            <div class="notification-bubble">
                <p><strong>A tutoring session has been scheduled for you.</strong></p>
